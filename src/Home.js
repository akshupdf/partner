  ...
  return (
    ...
    <section className="h-screen relative">
      ...
      <div className="container relative mx-auto lg:px-20 py-32 text-white flex flex-col lg:items-start justify-center h-full">
       ...
       <section className="h-screen relative flex w-[100%]">
        <div className='w-[50%] m-auto px-[14vh]'>
...
Thjesht vendosni detajet e apartamentit që ju intereson, dhe lini kalkulatorin tonë të bëjë pjesën tjetër!</p>
        ...
        <div className='w-[50%] m-auto h-screen text-center py-[20vh] text-white bg-[#6b9855bf]'>
...
<button className='text-xl  mt-20 bg-white text-black  px-[15vh] py-2 rounded-full'>Kalkulo</button>
      ...
      <section className=" font-mont flex h-screen w-[100%]">
    ...
    <div className='flex'>
       <h1 className="absolute top-[9vh] left-[4vh] text-white font-bold text-[40px]">Kompleksi  <span className='font-normal'>  JEHON...</span></h1> 

    </div>
    <h1 className='absolute left-[-5vh] bottom-[20vh] font-semibold text-white text-[25px] -rotate-90'>Më SHUMë</h1>
    </Link> 
  </div>
  ...
  <Link to ="/build"> 
       <div className="absolute inset-0 bg-black opacity-50"></div>
       <h1 className="absolute top-[5vh] left-[4vh] text-white  text-[20px]">DP Partners </h1> 
    <div className='flex'> <h1 className="absolute top-[9vh] left-[4vh] text-white font-bold text-[40px]">Lagjja E <span className='font-normal'> KALTËR</span></h1> 
  ...
  <Link to ="/build"> 
       <div className="absolute inset-0 bg-black opacity-50"></div>
       <h1 className="absolute top-[5vh] left-[4vh] text-white  text-[20px]">DP Partners </h1> 
    <div className='flex'> <h1 className="absolute top-[9vh] left-[4vh] text-white font-bold text-[40px]">Kompleksi <span className='font-normal'>TOPHANE</span></h1> 
    ...
    <h1 className='absolute left-[-5vh] bottom-[20vh] font-semibold text-white text-[25px] -rotate-90'>Më SHUMë</h1>
       ...
       <section className='h-screen mt-20  flex'>
        <div className='w-[50%] m-auto border-8 border-[#d3e6cb]  '>
        ...
        <div className='w-[50%] py-[50vh] px-[8vh] h-screen'>
        <h1 className='text-[80px] text-[#6b9855] font-bold font-mont'>Rreth Nesh</h1>
        <p className='text-xl font-light'>Ju prezantojmë emrin më të ri në industrinë e ndërtimit, “DP Partners,” i cili në vetvete përmban një grup kuadrash me përvojë të gjatë në këtë industri. Ky grup drejtohet nga Durim Prishtina, një emër i njohur me përvojë 20-vjeçare si bashkëthemelues dhe drejtor ekzekutiv i ndërmarrjes së njohur NTN Tregtia.
...
Ky është një koncept i ri që mungon në tregun kosovar dhe do të sjellë një partneritet të ndershëm dhe profesional në çdo aspekt.</p>
       ...
       <section className='h-screen mt-[60vh]  flex'>
       <div className='w-[50%] py-[50vh] px-[8vh] h-screen'>
        <h1 className='text-[60px] text-[#6b9855] font-semibold font-mont'>PRODHIMI</h1>
       ...
       <section className=" font-mont flex h-screen mt-[60vh] w-[100%]">
  ...
  <div className='flex'>
     <h1 className="absolute top-[9vh] left-[4vh] text-white font-bold text-[40px]">FASADA    <span className='font-normal'>   STRUKTURALE</span></h1> 
...
<div class="bg-box2  cursor-pointer">
    <Link to ="/build"> 
     ...
     {/* <h1 className="absolute top-[5vh] left-[4vh] text-white  text-[20px]">DP Partners </h1>  */}
  <div className='flex'>
     <h1 className="absolute top-[9vh] left-[4vh] text-white font-bold text-[40px]">BETONIMI </h1> 
...
<div class="bg-box2  cursor-pointer">
    <Link to ="/build"> 
     ...
     {/* <h1 className="absolute top-[5vh] left-[4vh] text-white  text-[20px]">DP Partners </h1>  */}
  <div className='flex'>
     <h1 className="absolute top-[9vh] left-[4vh] text-white font-bold text-[40px]">GRANITIT  </h1> 
...
<div class="bg-box2  cursor-pointer">
  ...
  <div className='flex'>
     <h1 className="absolute top-[9vh] left-[4vh] text-white font-bold text-[40px]">DYER   <span className='font-normal'>   DHE DRITARE</span></h1> 
